<?php if (isset($_SESSION['nombre'])) {
		...
		?>
		<div class="vista">
 		<form name="form-marca" action="../Controller/marca.php" method="POST"  onsubmit="return validarmarca()">
		...
		<?php 
			if (isset($_SESSION['save-exito']) and $_SESSION['save-exito'] == true) {?>
				...
				<strong>Exito!</strong> Se ha registrado exitosamente la marca...
				</div>
		<?php 	}elseif (isset($_SESSION['modif-exito']) and $_SESSION['modif-exito'] == true) {?>
				...
				<strong>Exito!</strong> Ha modificado exitosamente la marca...
				</div>
		<?php }elseif (isset($_SESSION['existe']) and $_SESSION['existe'] == true){ ?>
				...
				<strong>Error!</strong> La marca ya existe intente con otro.
				</div>
		<?php  }elseif (isset($_SESSION['eliminacion']) and $_SESSION['eliminacion'] == false){?>
				...
				<strong>Error!</strong> La marca, se esta utilizando imposible de eliminar...
				</div>
		<?php  }elseif(isset($_SESSION['save-exito']) and $_SESSION['save-exito'] == false){?>
				...
				<strong>Error!</strong> No se pudo registrar la Marca, verifique o pongase en contacto con el desarrollador...
				</div>
		<?php  }?>
		...
		<div class="container">
			<div class="row">
				<div class="tipo">
					...
					<tr>
						<td>Nombre:</td>
						<td><input type="text" name="nombre" placeholder="Ingrese una marca" class="marca" id="marca" maxlength="50" value="<?php echo $nombre; ?>" ></td>
					</tr>
		...
		<div class="container">
			<div class="row">
				<div class="tipo">
					...
					<tr>
						<td>Nombre:</td>
						<td><input type="text" name="nombre" placeholder="Ingrese una nueva marca" id="marca" class="marca" maxlength="50"></td>
					</tr>
					</table>
				</div>
