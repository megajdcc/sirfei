<?php if (isset($_SESSION['nombre'])) {
		...
		?>
		<div class="vista">
 		<form name="form-tiposervicio" action="../Controller/tiposervicio.php" method="POST"  onsubmit="return validartiposervicio()">
		...
		<?php 
			if (isset($_SESSION['save-exito']) and $_SESSION['save-exito'] == true) {?>
				...
				<strong>Exito!</strong> Se ha registrado exitosamente el tipo de servicio...
				</div>
		<?php 	}elseif (isset($_SESSION['modif-exito']) and $_SESSION['modif-exito'] == true) {?>
				...
				<strong>Exito!</strong> Ha modificado exitosamente el tipo de servicio...
				</div>
		<?php }elseif (isset($_SESSION['existe']) and $_SESSION['existe'] == true){ ?>
				...
				<strong>Error!</strong> El tipo de servicio ya existe intente con otro.
				</div>
		<?php  }elseif (isset($_SESSION['eliminacion']) and $_SESSION['eliminacion'] == false){?>
				...
				<strong>Error!</strong> El Tipo de servicio, se esta utilizando imposible de eliminar...
				</div>
		<?php  }elseif(isset($_SESSION['save-exito']) and $_SESSION['save-exito'] == false){?>
				...
				<strong>Error!</strong> No se pudo registrar El Tipo de servicio, verifique o pongase en contacto con el desarrollador...
				</div>
		<?php  }?>
		...
		<div class="container">
			<div class="row">
				<div class="tipo">
					...
					<tr>
						<td>Nombre:</td>
						<td><input type="text" name="nombre" placeholder="Ingrese tipo de servicio" class="tiposervicio" id="tiposervicio" maxlength="50" value="<?php echo $nombre; ?>" ></td>
					</tr>
		...
		<div class="container">
			<div class="row">
				<div class="tipo">
					...
					<tr>
						<td>Nombre:</td>
						<td><input type="text" name="nombre" placeholder="Ingrese un nuevo tipo de servicio" id="nombre" class="nombre" maxlength="50"></td>
					</tr>
					</table>
				</div>
