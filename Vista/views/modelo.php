<?php if (isset($_SESSION['nombre'])) {
		...
		?>
		<div class="vista">
 		<form name="form-modelo" action="../Controller/modelo.php" method="POST"  onsubmit="return validarmodelo()">
		...
		<?php 
			if (isset($_SESSION['save-exito']) and $_SESSION['save-exito'] == true) {?>
				...
				<strong>Exito!</strong> Se ha registrado exitosamente el modelo...
				</div>
		<?php 	}elseif (isset($_SESSION['modif-exito']) and $_SESSION['modif-exito'] == true) {?>
				...
				<strong>Exito!</strong> Ha modificado exitosamente el modelo...
				</div>
		<?php }elseif (isset($_SESSION['existe']) and $_SESSION['existe'] == true){ ?>
				...
				<strong>Error!</strong> El Modelo ya existe intente con otro.
				</div>
		<?php  }elseif (isset($_SESSION['eliminacion']) and $_SESSION['eliminacion'] == false){?>
				...
				<strong>Error!</strong> El Modelo, se esta utilizando imposible de eliminar...
				</div>
		<?php  }elseif(isset($_SESSION['save-exito']) and $_SESSION['save-exito'] == false){?>
				...
				<strong>Error!</strong> No se pudo registrar El Modelo, verifique o pongase en contacto con el desarrollador...
				</div>
		<?php  }?>
		...
		<div class="container">
			<div class="row">
				<div class="tipo">
					...
					<tr>
						<td>Modelo:</td>
						<td><input type="text" name="nombre" placeholder="Ingrese un nuevo modelo" class="modelo" id="modelo" maxlength="50" value="<?php echo $nombre; ?>" ></td>
					</tr>
		...
		<div class="container">
			<div class="row">
				<div class="tipo">
					...
					<tr>
						<td>Modelo:</td>
						<td><input type="text" name="nombre" placeholder="Ingrese un nuevo modelo" id="nombre" class="nombre" maxlength="50"></td>
					</tr>
					</table>
				</div>
